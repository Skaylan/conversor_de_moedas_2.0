...
const getServerData = async (currencyCodeOne, currencyCodeTwo, inputValue) => {
    ...
    const request = await fetch("https://conversordemoedas.up.railway.app/handle_conversion", {
        method: 'POST',
        mode: 'cors',
        headers: {
...
const getChartData = async () => {
    ...
    const dates = []
    const arr = []
    const serverData = await fetch(' https://conversordemoedas.up.railway.app/get_chart_data', {
        method: 'GET',
        mode: 'cors',
